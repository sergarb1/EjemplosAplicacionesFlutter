    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: AnimatedSwitcher(
          ...
          child: Checkbox(
            key: ValueKey<bool>(tarea.estaCompletada), // Clave única para animación
            ...
            activeColor: Theme.of(context).colorScheme.secondary, // Color del checkbox activo
          ...
          children: [
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  decoration: tarea.estaCompletada ? TextDecoration.lineThrough : null, // Línea tachada si está completada
                  color: tarea.estaCompletada
                      ? Theme.of(context).colorScheme.onSurface.withAlpha(128) // Color atenuado si está completada
                      : Theme.of(context).colorScheme.onSurface, // Color normal si no está completada
